...
public class DateTimePickerView extends PickerViewGroup {
    ...
    public void setGradientColors(int[] gradientColors) {
        ...
        if(dayPickerView != null) dayPickerView.setGradientColors(gradientColors);
        if(datePickerView != null) datePickerView.setGradientColors(gradientColors);
        if(hourPickerView != null) hourPickerView.setGradientColors(gradientColors);
        if(minutePickerView != null) minutePickerView.setGradientColors(gradientColors);
        if(timePickerView != null) timePickerView.setGradientColors(gradientColors);
    }

    public void setTextColor(int textColor) {
        if(yearPickerView != null) yearPickerView.setTextColor(textColor);
        if(monthPickerView != null) monthPickerView.setTextColor(textColor);
        if(dayPickerView != null) dayPickerView.setTextColor(textColor);
        if(datePickerView != null) datePickerView.setTextColor(textColor);
        if(hourPickerView != null) hourPickerView.setTextColor(textColor);
        if(minutePickerView != null) minutePickerView.setTextColor(textColor);
    ...
    public void setTextSize(int textSize) {
        ...
        if(dayPickerView != null) dayPickerView.setTextSize(textSize);
        if(datePickerView != null) datePickerView.setTextSize(textSize);
        if(hourPickerView != null) hourPickerView.setTextSize(textSize);
        if(minutePickerView != null) minutePickerView.setTextSize(textSize);
        if(timePickerView != null) timePickerView.setTextSize(textSize);
    }

    public void setItemHeight(int height) {
        if(yearPickerView != null) yearPickerView.setItemHeight(height);
        if(monthPickerView != null) monthPickerView.setItemHeight(height);
        if(dayPickerView != null) dayPickerView.setItemHeight(height);
        if(datePickerView != null) datePickerView.setItemHeight(height);
    ...
    public interface OnSelectedDateChangedListener {
        void onSelectedDateChanged(DateTimePickerView view, Calendar date);
    }
        ...
        public String getText() {
            ...
            switch (field) {
                case FIELD_YEAR:
                    ...
                    break;
                case FIELD_MONTH:
                    text = String.format(Locale.getDefault(), "%02d", value + 1);
                    break;
                case FIELD_DAY:
